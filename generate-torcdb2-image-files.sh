...
then
  ...
  echo "cluster of N machines and convert the dataset into TorcDB2 images, "
...
echo "Converting dataset files to TorcDB2 images..."
./convert-ldbc-snb-dataset-to-torcdb2-images.sh ${SERVER_LIST}.tmp ${REMOTE_DIR}/${DATASET_DIR} ${GRAPH_NAME}
echo 
