...
//  mkdir(output_social_network_supp_dir.c_str(), S_IRWXU | S_IRWXG | S_IROTH | S_IXOTH);
  ...
  string entity_types[] {"comment", "forum", "organisation", "person", "place", "post", "tag", "tagclass", "comment_hasCreator_person", "comment_hasCreator_person_ridx", "comment_hasTag_tag", "comment_hasTag_tag_ridx", "comment_isLocatedIn_place", "comment_isLocatedIn_place_ridx", "comment_replyOf_comment", "comment_replyOf_comment_ridx", "comment_replyOf_post", "comment_replyOf_post_ridx", "forum_containerOf_post", "forum_containerOf_post_ridx", "forum_hasMember_person", "forum_hasMember_person_ridx", "forum_hasModerator_person", "forum_hasModerator_person_ridx", "forum_hasTag_tag", "forum_hasTag_tag_ridx", "organisation_isLocatedIn_place", "organisation_isLocatedIn_place_ridx", "person_email_emailaddress", "person_hasInterest_tag", "person_hasInterest_tag_ridx", "person_isLocatedIn_place", "person_isLocatedIn_place_ridx", "person_knows_person", "person_likes_comment", "person_likes_comment_ridx", "person_likes_post", "person_likes_post_ridx", "person_speaks_language", "person_studyAt_organisation", "person_studyAt_organisation_ridx", "person_workAt_organisation", "person_workAt_organisation_ridx", "place_isPartOf_place", "place_isPartOf_place_ridx", "post_hasCreator_person", "post_hasCreator_person_ridx", "post_hasTag_tag", "post_hasTag_tag_ridx", "post_isLocatedIn_place", "post_isLocatedIn_place_ridx", "tagclass_isSubclassOf_tagclass", "tagclass_isSubclassOf_tagclass_ridx", "tag_hasType_tagclass", "tag_hasType_tagclass_ridx"};
