...
then
  ...
  echo "convert them to TorcDB2 RAMCloud image files in parallel."
  echo ""
  echo "Usage: convert-ldbc-snb-dataset-to-torcdb2-images.sh SERVER_LIST REMOTE_DIR GRAPH_NAME"
